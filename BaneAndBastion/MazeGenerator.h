 ...
 * * This class implements the IEnvironmentGenerator interface to create
 * structured layouts, such as corridors and rooms, using deterministic
 * algorithms.
 */
class MazeGenerator : public IEnvironmentGenerator {
 public:
   ...
   * @param safeRadiusCells Radius in cells around the safe position to keep
   * clear.
