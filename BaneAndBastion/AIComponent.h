...
class AIComponent : public FalkonEngine::Component {
 public:
  ...
  /**
   * @brief Initializes the AI with specific parameters and a navigation
   * strategy.
   ...
   * @param collision The collision mask of this entity to determine passable
   * terrain.
   */
 ...
 private:
  ...
  std::unique_ptr<IPathfindingStrategy>
      m_strategy;  ///< Strategy for path generation.
