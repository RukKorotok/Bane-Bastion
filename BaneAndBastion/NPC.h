...
class NPC : public Character {
 public:
  ...
  /**
   * @brief Defines the behavior when this NPC attacks or interacts with another
   * object. Overrides the base Character hit logic (e.g., applying damage or
  ...
  /**
   * @brief Observer pattern implementation to handle global or local game
   * events. Processes events such as "MovementFinished" from AIMoveComponent or
   * "TargetSpotted".
