...
class AStarUtils {
 public:
   ...
   * @param seekerCategory Collision category of the agent to check
   * traversability.
   * @return A vector of grid coordinates representing the path. Returns empty
   * if no path found.
   */
  static std::vector<FalkonEngine::Vector2Di> FindPath(
