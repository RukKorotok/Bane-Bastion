...
/**
 * @brief Singleton registry that defines movement constraints for each cell
 * type.
...
class CellRegistry {
 public:
   ...
   * @return A bitmask representing which categories cannot pass through this
   * cell.
   */
 ...
 private:
  ...
  CellRegistry() {
    ...
    std::uint8_t AllWalking = FalkonEngine::CollisionCategory::Player |
    ...
    // Obstacle (e.g. Bushes): Blocks movement but allows projectiles/flying
    // units
