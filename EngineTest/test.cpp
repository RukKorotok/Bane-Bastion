...
{
	FalkonEngine::Vector2D<float> vector(5.f, -3.f);
...
{
	FalkonEngine::Vector2D<float> first(4.f, -3.f);
	FalkonEngine::Vector2D<float> second(-4.f, 9.f);
	FalkonEngine::Vector2D<float> third = first + second;
...
{
	FalkonEngine::Vector2D<float> first(4.f, -3.f);
	FalkonEngine::Vector2D<float> second = -first;
...
{
	FalkonEngine::Vector2D<float> first(4.f, -3.f);
	FalkonEngine::Vector2D<float> second = -1.5f * first;
...
{
	FalkonEngine::Vector2D<float> first(4.f, -3.f);
	FalkonEngine::Vector2D<float> second = first * -1.5f;
...
{
	FalkonEngine::Vector2D<float> first(4.f, -3.f);
	FalkonEngine::Vector2D<float> second(4.f, -3.f);
	FalkonEngine::Vector2D<float> third(4.f, -6.2f);
...
{
	FalkonEngine::Vector2D<float> first(1.f, -3.f);
	FalkonEngine::Vector2D<float> second(6.f, -2.f);
